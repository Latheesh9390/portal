...
from routers import student_auth as student_auth_router
...
# Student auth (register / login / me) — separate account system from Admin
app.include_router(student_auth_router.router, prefix="/api/auth/student", tags=["student-auth"])

# Student-protected routes (own results only, no hall-ticket typing needed)
app.include_router(student_portal_router.router, prefix="/api/student", tags=["student-portal"])
