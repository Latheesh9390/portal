...
/**
 * Student info card + per-semester result tables. Shared by the public
 * hall-ticket search result page and the logged-in student's "My Results"
 * dashboard, so both stay visually identical.
 */
export default function MemoDisplay({ memo }) {
